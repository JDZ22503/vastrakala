            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-[40px] p-12 border border-[#D1A392]/20">                
                ...
                <form action="{{ route('admin.gallery.update', $gallery->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-8">
                        ...
                        <textarea id="summernote-description" name="description" placeholder="Size, material, and other technical details..." class="w-full border-gray-300 focus:border-[#D1A392] focus:ring-[#D1A392] rounded-[20px] shadow-sm resize-none p-4">{{ $gallery->description }}</textarea>
                    </div>
